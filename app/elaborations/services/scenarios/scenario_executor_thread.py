...
def _execute(scenario_input: ScenarioExecutionInput):
    with managed_session() as session:
        log(scenario_input.scenario_id, message=f"Starting execution of scenario '{scenario_input.scenario_code}'")
        ...
        for scenario_step in scenario_steps:
            log(scenario_input.scenario_id,
        ...
        log(scenario_input.scenario_id, message=f"Finished execution of scenario '{scenario_input.scenario_code}'",
